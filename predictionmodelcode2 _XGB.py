...
# Calculate the number of years (no_Years), how many years ago owner bought the car
...
random_var = RandomizedSearchCV(estimator=xgb, param_distributions=random_grid, scoring='neg_mean_squared_error',
